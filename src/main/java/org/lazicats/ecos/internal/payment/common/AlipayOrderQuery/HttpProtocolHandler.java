 ...
 * @功能 HttpClient方式访问获取远程HTTP数据
 * 
 * @author MingJun_Guo
 * @创建日期：2013-12-17下午2:14:24
 * 
 */
public class HttpProtocolHandler {
	 ...
	 * @return
	 */
	protected static HttpProtocolHandler getInstance() {
	 ...
	 *             , IOException
	 */
	protected HttpResponse execute(HttpRequest request, String strParaFileName,
