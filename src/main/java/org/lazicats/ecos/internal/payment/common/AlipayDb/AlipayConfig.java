...
public class AlipayConfig {
	...
	//public static String partner = "2088701809260784";
	
	// 交易安全检验码，由数字和字母组成的32位字符串
	//public static String key = "nspb7q9v9nr1fnkaxfgxwas7xilg0fq0";
	
	// 签约支付宝账号或卖家收款支付宝帐户
	//public static String seller_email = "igrandbuy@igrandbuy.net";
	
	// notify_url 交易过程中服务器通知的页面 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
	//public static String notify_url = "http://116.204.64.165:7880/Ailpay_db/notify_url.jsp";
	
	// 付完款后跳转的页面 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
	//public static String return_url = "http://116.204.64.165:7880/Ailpay_db/return_url.jsp";
	
	// 网站商品的展示地址，不允许加?id=123这类自定义参数
	//public static String show_url = "http://www.google.com.hk";
