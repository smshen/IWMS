...
public class GatewayOrderQueryServiceLocator extends
		org.apache.axis.client.Service implements GatewayOrderQueryService {
	...
	public GatewayOrderQueryServiceLocator(java.lang.String wsdlLoc,
	...
	private String gatewayOrderQuery_address = CommonPayInfo.BankPayInfo.get("rmbport_queryurl");
	...
	public GatewayOrderQuery getgatewayOrderQuery(java.net.URL portAddress)
			throws javax.xml.rpc.ServiceException {
		try {
			GatewayOrderQuerySoapBindingStub _stub = new GatewayOrderQuerySoapBindingStub(
					portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface)
			throws javax.xml.rpc.ServiceException {
		try {
			if (GatewayOrderQuery.class
					.isAssignableFrom(serviceEndpointInterface)) {
				GatewayOrderQuerySoapBindingStub _stub = new GatewayOrderQuerySoapBindingStub(
						new java.net.URL(gatewayOrderQuery_address), this);
				_stub.setPortName(getgatewayOrderQueryWSDDServiceName());
				return _stub;
			}
