...
public class Trade {
	...
	public String toString() {
		return "Trade [buyer_email=" + buyer_email + ", buyer_id=" + buyer_id
				+ ", discount=" + discount + ", flag_trade_locked="
				+ flag_trade_locked + ", gmt_create=" + gmt_create
				+ ", gmt_last_modified_time=" + gmt_last_modified_time
				+ ", gmt_payment=" + gmt_payment + ", is_total_fee_adjust="
				+ is_total_fee_adjust + ", operator_role=" + operator_role
				+ ", out_trade_no=" + out_trade_no + ", payment_type="
				+ payment_type + ", price=" + price + ", seller_email="
				+ seller_email + ", seller_id=" + seller_id + ", subject="
				+ subject + ", to_buyer_fee=" + to_buyer_fee
				+ ", to_seller_fee=" + to_seller_fee + ", total_fee="
				+ total_fee + ", trade_no=" + trade_no + ", trade_status="
				+ trade_status + ", use_coupon=" + use_coupon + "]";
	}
