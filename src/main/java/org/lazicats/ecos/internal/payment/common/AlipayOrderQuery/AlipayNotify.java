...
public class AlipayNotify {
	 ...
	 * 支付宝消息验证地址
	 */
	private static final String HTTPS_VERIFY_URL = CommonPayInfo.BankPayInfo.get("alipay_verifyUrl");
	 ...
	 * @return 验证结果
	 */
	protected static boolean verify(Map<String, String> params) {
	...
	private static boolean getSignVeryfy(Map<String, String> Params, String sign) {
		...
		if (AlipayConfig.sign_type.equals("MD5")) {
			isSign = MD5.verify(preSignStr, sign,
