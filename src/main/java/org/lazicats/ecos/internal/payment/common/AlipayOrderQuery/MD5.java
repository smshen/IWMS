...
public class MD5 {
	 ...
	 * @return 签名结果
	 */
	protected static String sign(String text, String key, String input_charset) {
		text = text + key;
	 ...
	 * @return 签名结果
	 */
	protected static boolean verify(String text, String sign, String key,
