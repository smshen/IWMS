...
public class PinUtils {
	...
	public static String getEncryptedPin(String pin, String pan, String certFile)
			throws Exception {
	...
	public static void main(String[] args) throws Exception {
		System.out.println("PIN BLOCK="
				+ Long.toHexString(getPinBlock("111111", "4160098111110001")));
		System.out.println("Encrypted Pin="
				+ getEncryptedPin("111111", "4160098111110001",
						"D:\\test_enc.cer"));
	}
}
