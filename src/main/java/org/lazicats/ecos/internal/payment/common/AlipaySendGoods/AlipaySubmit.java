...
public class AlipaySubmit {
	...
	/**
	 * 支付宝提供给商户的服务接入网关URL(新) 集成后采用配置|2013年10月22日 17:39:53
	 */
	...
	public static String buildRequest(Map<String, String> sParaTemp,
		...
		sbHtml.append("<form id=\"alipaysubmit\" name=\"alipaysubmit\" action=\""
				//+ ALIPAY_GATEWAY_NEW
				+ CommonPayInfo.BankPayInfo.get("alipay_sendGoodsUrl")
				+ "_input_charset="
				+ CommonPayInfo.BankPayInfo.get("alipay_input_charset")
				+ "\" method=\"" + strMethod + "\">");
	...
	public static String buildRequest(String strParaFileName,
		...
		request.setUrl(CommonPayInfo.BankPayInfo.get("alipay_sendGoodsUrl") + "_input_charset="
				+ CommonPayInfo.BankPayInfo.get("alipay_input_charset"));
	...
	public static String query_timestamp() throws MalformedURLException,
		...
		String strUrl = CommonPayInfo.BankPayInfo.get("alipay_sendGoodsUrl") + "service=query_timestamp&partner="
